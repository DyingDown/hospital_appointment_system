package io.yao.hospital.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import io.yao.hospital.mapper.HospitalSetMapper;
import io.yao.hospital.mapper.ScheduleMapper;
import io.yao.hospital.model.HospitalSet;
import io.yao.hospital.model.Schedule;
import io.yao.hospital.service.ApiService;
import io.yao.hospital.util.BeanUtils;
import io.yao.hospital.util.HttpRequestHelper;
import io.yao.hospital.util.HarpException;
...
public class ApiServiceImpl implements ApiService {
    ...
    public boolean saveHospital(String data) {
        ...
        if(null != respone && 200 == respone.getIntValue("code")) {
            ...
            throw new HarpException(respone.getString("message"), 201);
        }
    }
